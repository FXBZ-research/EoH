...
par_sga.crossoverType = 'LLM_Operator' ;        % 交叉算子: OX PMX CX LLM_Operator
...
par_sga.replacementType = 'Elitism';  % 替换策略: Elitism精英保留
par_sga.isLocalSearch = true;
% GA参数
par_sga.maxIter = 50;  % 最大迭代次数
par_sga.noIter = 500;     % 不改进迭代次数
par_sga.popSize = 50;                    % 种群规模
par_sga.crossoverProb = 0.8;             % 交叉概率 706 1变异
par_sga.mutationProb = 0.4;              % 变异概率
